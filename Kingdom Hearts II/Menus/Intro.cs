...
namespace ReFined.KH2.Menus
{
    public class Intro
    {
        ...
        public Intro()
        {
            ...
            var _entAutosave = new Entry(3, 0x5733, 0x0000, [0x5705, 0x5707, 0x5709], [0x5706, 0x5708, 0x570A]);
            var _entController = new Entry(2, 0x5737, 0x0000, [0x5723, 0x5725], [0x5724, 0x5726]);
